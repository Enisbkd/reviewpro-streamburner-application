...
/**
 * REST controller for managing {@link com.sbm.mc.domain.RvpApilodging}.
 */
@RestController
...
public class RvpApilodgingResource {
    ...
    public RvpApilodgingResource(RvpApilodgingService rvpApilodgingService, RvpApilodgingRepository rvpApilodgingRepository) {
    ...
    public ResponseEntity<RvpApilodging> createRvpApilodging(@RequestBody RvpApilodging rvpApilodging) throws URISyntaxException {
        ...
        rvpApilodging = rvpApilodgingService.save(rvpApilodging);
    ...
    public ResponseEntity<RvpApilodging> updateRvpApilodging(
        ...
        rvpApilodging = rvpApilodgingService.update(rvpApilodging);
    ...
    public ResponseEntity<RvpApilodging> partialUpdateRvpApilodging(
        ...
        Optional<RvpApilodging> result = rvpApilodgingService.partialUpdate(rvpApilodging);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<RvpApilodging>> getAllRvpApilodgings(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of RvpApilodgings");
        Page<RvpApilodging> page = rvpApilodgingService.findAll(pageable);
    ...
    public ResponseEntity<RvpApilodging> getRvpApilodging(@PathVariable("id") String id) {
        ...
        Optional<RvpApilodging> rvpApilodging = rvpApilodgingService.findOne(id);
    ...
    public ResponseEntity<Void> deleteRvpApilodging(@PathVariable("id") String id) {
        ...
        rvpApilodgingService.delete(id);
