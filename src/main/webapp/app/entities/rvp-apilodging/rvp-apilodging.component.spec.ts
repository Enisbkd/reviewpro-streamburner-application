  ...
  describe('RvpApilodging Management Component', () => {
    ...
    describe('Mount', () => {
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(rvpApilodgingServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      ...
      it('should load a page', async () => {
        ...
        // THEN
        expect(rvpApilodgingServiceStub.retrieve.called).toBeTruthy();
        expect(comp.rvpApilodgings[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(rvpApilodgingServiceStub.retrieve.called).toBeFalsy();
      });
