      ...
      <table class="table table-striped" aria-describedby="rvpApiLodgingScores">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingScore.lodgingId')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingScore.surveyId')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingScore.nps')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingScore.rating')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingScore.customScore')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingScore.fd')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingScore.td')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
