      ...
      <table class="table table-striped" aria-describedby="rvpApiLodgingCqis">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingCqi.lodgingId')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingCqi.averageCurrentPeriod')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingCqi.tendancy')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingCqi.change')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingCqi.name')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingCqi.averagePreviousPeriod')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingCqi.fd')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiLodgingCqi.td')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
