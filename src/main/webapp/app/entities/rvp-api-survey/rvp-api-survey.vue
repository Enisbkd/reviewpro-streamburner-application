      ...
      <table class="table table-striped" aria-describedby="rvpApiSurveys">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiSurvey.overallScoreEnabled')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiSurvey.languages')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiSurvey.outOf')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiSurvey.name')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiSurvey.active')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiSurvey.pids')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiSurvey.primary')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
