...
public class JacksonDeserializerConfig extends AbstractConfig {
    ...
    public static final String USE_BIG_DECIMAL_FOR_FLOATS_CONFIG = "use.big.decimal.for.floats.enable";
    public static final String USE_BIG_INTEGER_FOR_INTS_CONFIG = "use.big.integer.for.ints.enable";
    public static final String USE_LONG_FOR_INTS_CONFIG = "use.long.for.ints.enable";
    public static final String USE_JAVA_ARRAY_FOR_JSON_ARRAY_CONFIG = "use.java.array.for.json.array.enable";
    public static final String FAIL_ON_UNKNOWN_PROPERTIES_CONFIG = "fail.on.unknown.properties.enable";
    public static final String FAIL_ON_NULL_FOR_PRIMITIVES_CONFIG = "fail.on.null.for.primitives.enable";
    public static final String FAIL_ON_NUMBERS_FOR_ENUMS_CONFIG = "fail.on.numbers.for.enums.enable";
    public static final String FAIL_ON_INVALID_SUBTYPE_CONFIG = "fail.on.invalid.subtype.enable";
    public static final String FAIL_ON_READING_DUP_TREE_KEY_CONFIG = "fail.on.reading.dup.tree.key.enable";
    public static final String FAIL_ON_IGNORED_PROPERTIES_CONFIG = "fail.on.ignored.properties.enable";
    public static final String FAIL_ON_UNRESOLVED_OBJECT_IDS_CONFIG = "fail.on.unresolved.object.ids.enable";
    public static final String FAIL_ON_MISSING_CREATOR_PROPERTIES_CONFIG = "fail.on.missing.creator.properties.enable";
    public static final String FAIL_ON_NULL_CREATOR_PROPERTIES_CONFIG = "fail.on.null.creator.properties.enable";
    public static final String FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY_CONFIG = "fail.on.missing.external.type.id.property.enable";
    public static final String FAIL_ON_TRAILING_TOKENS_CONFIG = "fail.on.trailing.tokens.enable";
    public static final String WRAP_EXCEPTIONS_CONFIG = "wrap.exceptions.enable";
    public static final String ACCEPT_SINGLE_VALUE_AS_ARRAY_CONFIG = "accept.single.value.as.array.enable";
    public static final String UNWRAP_SINGLE_VALUE_ARRAYS_CONFIG = "unwrap.single.value.arrays.enable";
    public static final String UNWRAP_ROOT_VALUE_CONFIG = "unwrap.root.value.enable";
    public static final String ACCEPT_EMPTY_STRING_AS_NULL_OBJECT_CONFIG = "accept.empty.string.as.null.object.enable";
    public static final String ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT_CONFIG = "accept.empty.array.as.null.object.enable";
    public static final String ACCEPT_FLOAT_AS_INT_CONFIG = "accept.float.as.int.enable";
    public static final String READ_ENUMS_USING_TO_STRING_CONFIG = "read.enums.using.to.string.enable";
    public static final String READ_UNKNOWN_ENUM_VALUES_AS_NULL_CONFIG = "read.unknown.enum.values.as.null.enable";
    public static final String READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE_CONFIG = "read.unknown.enum.values.using.default.value.enable";
    public static final String READ_DATE_TIMESTAMPS_AS_NANOSECONDS_CONFIG = "read.date.timestamps.as.nanoseconds.enable";
    public static final String ADJUST_DATES_TO_CONTEXT_TIME_ZONE_CONFIG = "adjust.dates.to.context.time.zone.enable";
    public static final String EAGER_DESERIALIZER_FETCH_CONFIG = "eager.deserializer.fetch.enable";
    public static final String OUTPUT_CLASS_CONFIG = "output.class";
    ...
    static final String USE_BIG_DECIMAL_FOR_FLOATS_DOC =
        "See [USE_BIG_DECIMAL_FOR_FLOATS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#USE_BIG_DECIMAL_FOR_FLOATS)";
    static final String USE_BIG_INTEGER_FOR_INTS_DOC =
        "See [USE_BIG_INTEGER_FOR_INTS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#USE_BIG_INTEGER_FOR_INTS)";
    static final String USE_LONG_FOR_INTS_DOC =
        "See [USE_LONG_FOR_INTS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#USE_LONG_FOR_INTS)";
    static final String USE_JAVA_ARRAY_FOR_JSON_ARRAY_DOC =
        "See [USE_JAVA_ARRAY_FOR_JSON_ARRAY](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#USE_JAVA_ARRAY_FOR_JSON_ARRAY)";
    static final String FAIL_ON_UNKNOWN_PROPERTIES_DOC =
        "See [FAIL_ON_UNKNOWN_PROPERTIES](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_UNKNOWN_PROPERTIES)";
    static final String FAIL_ON_NULL_FOR_PRIMITIVES_DOC =
        "See [FAIL_ON_NULL_FOR_PRIMITIVES](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_NULL_FOR_PRIMITIVES)";
    static final String FAIL_ON_NUMBERS_FOR_ENUMS_DOC =
        "See [FAIL_ON_NUMBERS_FOR_ENUMS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_NUMBERS_FOR_ENUMS)";
    static final String FAIL_ON_INVALID_SUBTYPE_DOC =
        "See [FAIL_ON_INVALID_SUBTYPE](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_INVALID_SUBTYPE)";
    static final String FAIL_ON_READING_DUP_TREE_KEY_DOC =
        "See [FAIL_ON_READING_DUP_TREE_KEY](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_READING_DUP_TREE_KEY)";
    static final String FAIL_ON_IGNORED_PROPERTIES_DOC =
        "See [FAIL_ON_IGNORED_PROPERTIES](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_IGNORED_PROPERTIES)";
    static final String FAIL_ON_UNRESOLVED_OBJECT_IDS_DOC =
        "See [FAIL_ON_UNRESOLVED_OBJECT_IDS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_UNRESOLVED_OBJECT_IDS)";
    static final String FAIL_ON_MISSING_CREATOR_PROPERTIES_DOC =
        "See [FAIL_ON_MISSING_CREATOR_PROPERTIES](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_MISSING_CREATOR_PROPERTIES)";
    static final String FAIL_ON_NULL_CREATOR_PROPERTIES_DOC =
        "See [FAIL_ON_NULL_CREATOR_PROPERTIES](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_NULL_CREATOR_PROPERTIES)";
    static final String FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY_DOC =
        "See [FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY)";
    static final String FAIL_ON_TRAILING_TOKENS_DOC =
        "See [FAIL_ON_TRAILING_TOKENS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#FAIL_ON_TRAILING_TOKENS)";
    static final String WRAP_EXCEPTIONS_DOC =
        "See [WRAP_EXCEPTIONS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#WRAP_EXCEPTIONS)";
    static final String ACCEPT_SINGLE_VALUE_AS_ARRAY_DOC =
        "See [ACCEPT_SINGLE_VALUE_AS_ARRAY](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#ACCEPT_SINGLE_VALUE_AS_ARRAY)";
    static final String UNWRAP_SINGLE_VALUE_ARRAYS_DOC =
        "See [UNWRAP_SINGLE_VALUE_ARRAYS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#UNWRAP_SINGLE_VALUE_ARRAYS)";
    static final String UNWRAP_ROOT_VALUE_DOC =
        "See [UNWRAP_ROOT_VALUE](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#UNWRAP_ROOT_VALUE)";
    static final String ACCEPT_EMPTY_STRING_AS_NULL_OBJECT_DOC =
        "See [ACCEPT_EMPTY_STRING_AS_NULL_OBJECT](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#ACCEPT_EMPTY_STRING_AS_NULL_OBJECT)";
    static final String ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT_DOC =
        "See [ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT)";
    static final String ACCEPT_FLOAT_AS_INT_DOC =
        "See [ACCEPT_FLOAT_AS_INT](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#ACCEPT_FLOAT_AS_INT)";
    static final String READ_ENUMS_USING_TO_STRING_DOC =
        "See [READ_ENUMS_USING_TO_STRING](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#READ_ENUMS_USING_TO_STRING)";
    static final String READ_UNKNOWN_ENUM_VALUES_AS_NULL_DOC =
        "See [READ_UNKNOWN_ENUM_VALUES_AS_NULL](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#READ_UNKNOWN_ENUM_VALUES_AS_NULL)";
    static final String READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE_DOC =
        "See [READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE)";
    static final String READ_DATE_TIMESTAMPS_AS_NANOSECONDS_DOC =
        "See [READ_DATE_TIMESTAMPS_AS_NANOSECONDS](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#READ_DATE_TIMESTAMPS_AS_NANOSECONDS)";
    static final String ADJUST_DATES_TO_CONTEXT_TIME_ZONE_DOC =
        "See [ADJUST_DATES_TO_CONTEXT_TIME_ZONE](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#ADJUST_DATES_TO_CONTEXT_TIME_ZONE)";
    static final String EAGER_DESERIALIZER_FETCH_DOC =
        "See [EAGER_DESERIALIZER_FETCH](https://fasterxml.github.io/jackson-databind/javadoc/2.9/com/fasterxml/jackson/databind/DeserializationFeature.html#EAGER_DESERIALIZER_FETCH)";
    static final String OUTPUT_CLASS_DOC = "The java class to deserialize to.";
    ...
    static {
        ...
        configFeatureToConfig.put(
            ...
            FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY_CONFIG
        );
        configToConfigFeature.put(
            FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY_CONFIG,
            DeserializationFeature.FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY
        ...
        configFeatureToConfig.put(
            ...
            READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE_CONFIG
        );
        configToConfigFeature.put(
            READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE_CONFIG,
            DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE
    ...
    public static ConfigDef config() {
        ...
        config.define(
            USE_BIG_DECIMAL_FOR_FLOATS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.USE_BIG_DECIMAL_FOR_FLOATS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_BIG_DECIMAL_FOR_FLOATS_DOC
        );
        config.define(
            USE_BIG_INTEGER_FOR_INTS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.USE_BIG_INTEGER_FOR_INTS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_BIG_INTEGER_FOR_INTS_DOC
        );
        config.define(
            USE_LONG_FOR_INTS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.USE_LONG_FOR_INTS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_LONG_FOR_INTS_DOC
        );
        config.define(
            USE_JAVA_ARRAY_FOR_JSON_ARRAY_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.USE_JAVA_ARRAY_FOR_JSON_ARRAY.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            USE_JAVA_ARRAY_FOR_JSON_ARRAY_DOC
        );
        config.define(
            FAIL_ON_UNKNOWN_PROPERTIES_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_UNKNOWN_PROPERTIES_DOC
        );
        config.define(
            FAIL_ON_NULL_FOR_PRIMITIVES_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_NULL_FOR_PRIMITIVES_DOC
        );
        config.define(
            FAIL_ON_NUMBERS_FOR_ENUMS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_NUMBERS_FOR_ENUMS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_NUMBERS_FOR_ENUMS_DOC
        );
        config.define(
            FAIL_ON_INVALID_SUBTYPE_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_INVALID_SUBTYPE.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_INVALID_SUBTYPE_DOC
        );
        config.define(
            FAIL_ON_READING_DUP_TREE_KEY_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_READING_DUP_TREE_KEY.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_READING_DUP_TREE_KEY_DOC
        );
        config.define(
            FAIL_ON_IGNORED_PROPERTIES_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_IGNORED_PROPERTIES.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_IGNORED_PROPERTIES_DOC
        );
        config.define(
            FAIL_ON_UNRESOLVED_OBJECT_IDS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_UNRESOLVED_OBJECT_IDS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_UNRESOLVED_OBJECT_IDS_DOC
        );
        config.define(
            FAIL_ON_MISSING_CREATOR_PROPERTIES_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_MISSING_CREATOR_PROPERTIES.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_MISSING_CREATOR_PROPERTIES_DOC
        );
        config.define(
            FAIL_ON_NULL_CREATOR_PROPERTIES_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_NULL_CREATOR_PROPERTIES.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_NULL_CREATOR_PROPERTIES_DOC
        );
        config.define(
            FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_MISSING_EXTERNAL_TYPE_ID_PROPERTY_DOC
        );
        config.define(
            FAIL_ON_TRAILING_TOKENS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.FAIL_ON_TRAILING_TOKENS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            FAIL_ON_TRAILING_TOKENS_DOC
        );
        config.define(
            WRAP_EXCEPTIONS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.WRAP_EXCEPTIONS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            WRAP_EXCEPTIONS_DOC
        );
        config.define(
            ACCEPT_SINGLE_VALUE_AS_ARRAY_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ACCEPT_SINGLE_VALUE_AS_ARRAY_DOC
        );
        config.define(
            UNWRAP_SINGLE_VALUE_ARRAYS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            UNWRAP_SINGLE_VALUE_ARRAYS_DOC
        );
        config.define(
            UNWRAP_ROOT_VALUE_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.UNWRAP_ROOT_VALUE.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            UNWRAP_ROOT_VALUE_DOC
        );
        config.define(
            ACCEPT_EMPTY_STRING_AS_NULL_OBJECT_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ACCEPT_EMPTY_STRING_AS_NULL_OBJECT_DOC
        );
        config.define(
            ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT_DOC
        );
        config.define(
            ACCEPT_FLOAT_AS_INT_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.ACCEPT_FLOAT_AS_INT.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ACCEPT_FLOAT_AS_INT_DOC
        );
        config.define(
            READ_ENUMS_USING_TO_STRING_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.READ_ENUMS_USING_TO_STRING.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            READ_ENUMS_USING_TO_STRING_DOC
        );
        config.define(
            READ_UNKNOWN_ENUM_VALUES_AS_NULL_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            READ_UNKNOWN_ENUM_VALUES_AS_NULL_DOC
        );
        config.define(
            READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE_DOC
        );
        config.define(
            READ_DATE_TIMESTAMPS_AS_NANOSECONDS_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.READ_DATE_TIMESTAMPS_AS_NANOSECONDS.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            READ_DATE_TIMESTAMPS_AS_NANOSECONDS_DOC
        );
        config.define(
            ADJUST_DATES_TO_CONTEXT_TIME_ZONE_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.ADJUST_DATES_TO_CONTEXT_TIME_ZONE.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            ADJUST_DATES_TO_CONTEXT_TIME_ZONE_DOC
        );
        config.define(
            EAGER_DESERIALIZER_FETCH_CONFIG,
            ConfigDef.Type.BOOLEAN,
            DeserializationFeature.EAGER_DESERIALIZER_FETCH.enabledByDefault(),
            ConfigDef.Importance.MEDIUM,
            EAGER_DESERIALIZER_FETCH_DOC
        );
