  ...
  describe('RvpApiGlobalReview Management Component', () => {
    ...
    describe('Mount', () => {
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(rvpApiGlobalReviewServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      ...
      it('should load a page', async () => {
        ...
        // THEN
        expect(rvpApiGlobalReviewServiceStub.retrieve.called).toBeTruthy();
        expect(comp.rvpApiGlobalReviews[0]).toEqual(expect.objectContaining({ id: 123 }));
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(rvpApiGlobalReviewServiceStub.retrieve.called).toBeFalsy();
      });
