      ...
      <table class="table table-striped" aria-describedby="rvpApiGlobalReviews">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiGlobalReview.lodgingid')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiGlobalReview.prevGri')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiGlobalReview.distribution')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiGlobalReview.gri')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiGlobalReview.fd')"></span></th>
            <th scope="row"><span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApiGlobalReview.td')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
