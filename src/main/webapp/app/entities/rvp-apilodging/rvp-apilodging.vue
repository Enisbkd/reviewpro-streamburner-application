<template>
  <div>
    <h2 id="page-heading" data-cy="RvpApilodgingHeading">
      <span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApilodging.home.title')" id="rvp-apilodging-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApilodging.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'RvpApilodgingCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApilodging.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && rvpApilodgings && rvpApilodgings.length === 0">
      <span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApilodging.home.notFound')"></span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('name')">
              <span v-text="t$('reviewProStreamBurnerApplicationApp.rvpApilodging.name')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="reviewProStreamBurnerApplicationApp.rvpApilodging.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="t$('reviewProStreamBurnerApplicationApp.rvpApilodging.delete.question', { id: removeId })"
        ></p>
      </div>
    ...
    <div v-show="rvpApilodgings && rvpApilodgings.length > 0">
